...
- (void)show
{
    ...
    dialogView.layer.transform = CATransform3DMakeScale(0.7f, 0.7f, 1.0);
...
//    [dialogContainer.layer insertSublayer:gradient atIndex:0];
    ...
    UIView *hLineView = [[UIView alloc] initWithFrame:CGRectMake(0, dialogContainer.bounds.size.height - buttonHeight - buttonSpacerHeight, dialogContainer.bounds.size.width, 0.5)];
    hLineView.backgroundColor = [UIColor colorWithRed:225.0/255.0 green:226.0/255.0 blue:226.0/255.0 alpha:1.0f];
    
    UIView *vLineView = [[UIView alloc] initWithFrame:CGRectMake((dialogContainer.bounds.size.width - 0.5 ) / 2, dialogContainer.bounds.size.height - buttonHeight - buttonSpacerHeight, 0.5, buttonHeight)];
    
    vLineView.backgroundColor = hLineView.backgroundColor;
    
    [dialogContainer addSubview:hLineView];
    [dialogContainer addSubview:vLineView];
    // ^^^
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        if (i == 0) {
            [closeButton setTitleColor:[UIColor colorWithRed:40.0/255.0 green:142.0/255.0 blue:254.0/255.0 alpha:1.0f] forState:UIControlStateNormal];//按钮字体颜色
            [closeButton setTitleColor:[UIColor colorWithRed:40.0/255.0 green:142.0/255.0 blue:254.0/255.0 alpha:0.5f] forState:UIControlStateHighlighted];
        }else {
//            closeButton.backgroundColor = [UIColor whiteColor]; //设置按钮的背景颜色
            [closeButton setTitleColor:[UIColor colorWithRed:40.0/255.0 green:142.0/255.0 blue:254.0/255.0 alpha:1.0f] forState:UIControlStateNormal];
            [closeButton setTitleColor:[UIColor colorWithRed:40.0/255.0 green:142.0/255.0 blue:254.0/255.0 alpha:0.5f] forState:UIControlStateHighlighted];
        }
